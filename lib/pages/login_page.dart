...
class _LoginPageState extends State<LoginPage>
  ...
  Widget build(BuildContext context) {
    ...
    Color boxColor = Color(0xFFE3E3E3);
    Color loginButtonColor = Color(0xFF61A3BA);
        ...
        child: FadeTransition(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(
                  height:
                      90.0), // Add space between the logo and the user name section
                ...
                children: [
                  ...
                  TextButton(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                          color:
                              linkColor), // Set the text color to the link color
                    ),
                  ),
                ],
              ),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(30.0),
                  color:
                      loginButtonColor, // Set the background color to #61A3BA
                  boxShadow: [
                    BoxShadow(
                      color: Colors.black12, // Shadow color
                      spreadRadius: 1, // Spread radius
